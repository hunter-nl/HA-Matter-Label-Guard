...
# Changelog
## [v1.2.4](https://github.com/hunter-nl/HA-Matter-Label-Guard/releases/tag/v1.2.4)


### 🐛 Fixes
- [Fix: adjust formatting for new contributors section in changelog template](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/36) ([#36](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/36))
- [Fix(release): add 'feature' label to autolabeler and ensure auto-label job runs on pull requests](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/31) ([#31](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/31))
- [Fix(release): update autolabeler labels for bug and documentation](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/30) ([#30](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/30))

### ⬆️ Dependencies
- [Chore(deps):(deps): bump the dependencies group with 2 updates](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/35) ([#35](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/35))
- [Chore(deps):(deps): update ruff requirement from >=0.16.0 to >=0.16.1 in the dependencies group](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/32) ([#32](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/32))

### 📝 Documentation
- [Docs: improve README formatting and clarity](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/34) ([#34](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/34))
...
in [#35](https://github.com/hunter-nl/HA-Matter-Label-Guard/pull/35)

* @dependabot[bot] made their first contribution## [v1.2.3](https://github.com/hunter-nl/HA-Matter-Label-Guard/releases/tag/v1.2.3)
...
* @hunter-nl made their first contribution## Funding
